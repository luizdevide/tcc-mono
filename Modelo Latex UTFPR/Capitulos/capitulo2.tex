...
\begin{itemize}
	...
	\begin{figure}[!htb]
		\centering
		%begin{measuredfigure}
		\caption{Exemplo do evento install}
		\includegraphics[height=9cm]{./figuras/install.png} \quad
		\fonte{Autoria Propria}
		%end{measuredfigure}
	\end{figure}
	...
	\begin{figure}[!htb]
		\centering
		%begin{measuredfigure}
		\caption{Exemplo do evento activate}
		\includegraphics[height=8cm]{./figuras/activate.png} \quad
		\fonte{Autoria Propria}
		%end{measuredfigure}
	\end{figure}
	...
	\begin{figure}[!htb]
		\centering
		%begin{measuredfigure}
		\caption{Exemplo do evento message}
		\includegraphics[height=8cm]{./figuras/message.png} \quad
		\fonte{Autoria Propria}
		%end{measuredfigure}
	\end{figure}
