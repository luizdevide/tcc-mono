...
O desenvolvimento web pode ser separado em duas partes. A primeira parte sendo a do \textit{front-end}, e a segunda do \textit{back-end}.O \textit{front-end} é a parte na qual o usuário tem acesso, a interface de seu sistema. Nessa camada temos o uso das tecnologias HTML, CSS e JavaScript.  Já o back-end é o que controla as regras de negócio do sistema e o banco de dados. Geralmente programado usando ASP, PHP e Java \cite{Wales2014}. 
...
É nesse momento em que o CSS3 será utilizado. Ele será o responsável pela estilização da página. Pois através dele podemos alterar fontes, definir cores, e alterar a posição de cada elemento de nossa página. 
